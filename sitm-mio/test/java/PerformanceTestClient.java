...
public class PerformanceTestClient {
    ...
    public void initialize(String[] args) {
        ...
        String masterEndpoint = "tcp -h localhost -p 10000";
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: PerformanceTestClient <data_directory>");
            System.out.println("Example: PerformanceTestClient /path/to/csv/files");
            return;
        }
